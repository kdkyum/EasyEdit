#!/bin/bash -l
#SBATCH -o outputs/run_llama2_ft/%x/%A_%a.out
#SBATCH -e outputs/run_llama2_ft/%x/%A_%a.err
#SBATCH -D ./
#SBATCH -J run_llama2_ft
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p outputs/run_llama2_ft/${SLURM_JOB_NAME} outputs/run_llama2_ft/${SLURM_JOB_NAME} || true
...
HPARAMS_PATH=./hparams/TEST/FT/llama-7b/layer${LAYER_ID}
...
python run_edit.py \
  ...
  --metrics_save_path=results/llama2_ft/counterfact_country-capital/layer${LAYER_ID}.json
