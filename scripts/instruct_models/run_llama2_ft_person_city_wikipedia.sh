...
python run_edit.py \
  ...
  --correct_indices_path=./bilinear_probe/outputs/cli_batch_person-city_wikipedia/Llama-2-7b-chat-hf_embeddings/correct_indices.npz \
  --correct_bilinear_path=./bilinear_probe/outputs/cli_batch_person-city_wikipedia/Llama-2-7b-chat-hf_embeddings/person-city/bilinear_correct_ids.json \
