...
python run_edit.py \
  ...
  --correct_indices_path=./bilinear_probe/outputs/cli_batch_person-city/Mistral-7B-Instruct-v0.3_embeddings/correct_indices.npz \
  --correct_bilinear_path=./bilinear_probe/outputs/cli_batch_person-city/Mistral-7B-Instruct-v0.3_embeddings/person-city/bilinear_correct_ids.json \
