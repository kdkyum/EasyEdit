...
python run_edit.py \
  ...
  --correct_indices_path=./bilinear_probe/outputs/cli_batch_person-city/Llama-2-7b-chat-hf_embeddings/correct_indices.npz \
  --correct_bilinear_path=./bilinear_probe/outputs/cli_batch_person-city/Llama-2-7b-chat-hf_embeddings/person-city/bilinear_correct_ids.json \
  --metrics_save_path=results/llama2-chat_ft/counterfact_person-city/layer${LAYER_ID}.json \
  --chat_mode