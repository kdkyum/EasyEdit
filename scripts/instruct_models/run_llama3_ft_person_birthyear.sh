...
python run_edit_person_birthyear.py \
  ...
  --correct_indices_path=./bilinear_probe/outputs/truncated_person_birthyear/variance_1/Llama-3.1-8B-Instruct_embeddings/correct_indices.npz \
  --metrics_save_path=results/FT/Llama-3.1-8B-Instruct/counterfact_person_birthyear/layer${LAYER_ID}.json \
  --chat_mode