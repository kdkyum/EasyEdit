...
- 2024-04-24, EasyEdit announced support for the **ROME method for [Llama3-8B](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct)**. Users are advised to update their transformers package to version 4.40.0.
